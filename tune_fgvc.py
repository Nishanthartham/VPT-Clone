...
def setup(args, lr, wd, check_runtime=True):
    ...
    print("setting dist path in fgvc")
    cfg.DIST_INIT_PATH = "tcp://{}:4000".format("xulab-gpu1.pc.cc.cmu.edu")
    print("CFG distributed setup done in fgvc")
    ...
    for wd in wd_range:
        for lr in lr_range:
            ...
            try:
                ...
                continue
            print(f'Current tuning params are lr = {lr} wd = {wd}')
            train_main(cfg, args)
